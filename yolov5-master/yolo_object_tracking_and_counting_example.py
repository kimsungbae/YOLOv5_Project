            ...
            if not to.counted:
                ...
                if centroid[0] < (W // 2) - 20:
                    try:
                        ...
                        print('object_start_tuple(왼쪽 시작)', object_start_tuple)
                        print('objectID(왼쪽 시작)', objectID)
                    except:
                        pass
                ...
                # 객체가 오른쪽에서 시작
                    ...
                    try:
                        if len(object_start_tuple) < objectID:
                            ...
                            object_start_tuple = object_start_tuple + (1,)
                        print('object_start_tuple(오른쪽 시작)', object_start_tuple)
                        print('objectID(오른쪽 시작)', objectID)
                    except:
                        pass
